...
export function AccountNotificationsClient({ initial, csrfToken }: { initial: readonly NotificationItem[]; csrfToken: string }) {
  ...
  return <section className="shell customer-account-page">
    ...
    <CustomerHowItWorks><p>Οι ειδοποιήσεις συγκεντρώνουν αλλαγές από παραγγελίες, Ask Local, επιστροφές και τον λογαριασμό σου. Οι διαθέσιμες ενέργειες προκύπτουν από τον τύπο και το ασφαλές πλαίσιο της ειδοποίησης, όχι από το κείμενό της.</p></CustomerHowItWorks>
