...
export function AdminGiftCardsClient({ initial, csrfToken, liveEnabled }: { initial: readonly GiftCardView[]; csrfToken: string; liveEnabled: boolean }) {
  ...
  return <>
    ...
    {!liveEnabled ? <div className="workspace-inline-note"><strong>Public purchase disabled.</strong> Η υποδομή stored value είναι έτοιμη, αλλά η πώληση/checkout δωροκαρτών παραμένει gated μέχρι να εγκριθούν PSP, λογιστικός και φορολογικός χειρισμός.</div> : null}
