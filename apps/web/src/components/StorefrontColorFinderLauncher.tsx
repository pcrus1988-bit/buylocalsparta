    ...
    <>
      <button
        ...
        aria-label={showGateway
          ? "Άνοιγμα ΚΟΝΤΑ ΜΟΥ Color Finder"
          : "Άνοιγμα ΚΟΝΤΑ ΜΟΥ Color Finder · " + context.presentation.studioLabel}
        title={showGateway ? "KONTA MOY Color Finder" : "Color Finder · " + context.presentation.studioLabel}
      >
