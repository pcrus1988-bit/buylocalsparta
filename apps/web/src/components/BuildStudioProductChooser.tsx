...
function manufacturerFamilyTitle(brand: string, title: string): string {
  ...
  if (cleanTitle.toLocaleLowerCase("en").startsWith(cleanBrand.toLocaleLowerCase("en"))) {
    return cleanBrand.toLocaleUpperCase("el-GR") + cleanTitle.slice(cleanBrand.length);
  }
