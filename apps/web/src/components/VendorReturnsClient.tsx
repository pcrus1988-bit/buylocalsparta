...
export function VendorReturnsClient({ initial }: { initial: Workspace }) {
  ...
  return <>
    ...
    <WorkspaceMetricStrip items={[
      ...
      { label: "Active", value: activeCases, tone: activeCases ? "attention" : "default" },
      { label: "Replacement", value: replacementCases },
      { label: "Repair", value: repairCases }
    ]} />

    <section className="shell vendor-section">
      <WorkspaceSectionHeading eyebrow="Assigned cases" title="After-sales tasks" note="Eligibility και customer remedy έχουν ήδη αποφασιστεί από την πλατφόρμα. Εδώ εκτελείς μόνο το ανατεθειμένο operational task." />
