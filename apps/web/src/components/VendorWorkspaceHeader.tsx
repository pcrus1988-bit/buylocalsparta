...
export function VendorWorkspaceHeader() {
  ...
  return <header className={`workspace-header${menuOpen ? " is-menu-open" : ""}`}>
    ...
    <WorkspaceNavigation id="vendor-workspace-navigation" ariaLabel="Χώρος συνεργάτη" groups={VENDOR_WORKSPACE_NAVIGATION} onNavigate={() => setMenuOpen(false)} />
    <div className="workspace-footer workspace-footer-stacked">
      <span className="workspace-session"><i aria-hidden="true" /> Online</span>
