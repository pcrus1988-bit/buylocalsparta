...
export function DropshippingProductFieldControls({ offerId, fields, overridden }: Props) {
  ...
  return <details style={{ marginTop: 10 }}>
    <summary style={{ cursor: "pointer", fontWeight: 700 }}>Public fields {overridden ? "· override" : "· supplier defaults"}</summary>
