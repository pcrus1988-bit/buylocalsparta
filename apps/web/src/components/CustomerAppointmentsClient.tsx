...
export function CustomerAppointmentsClient({
  ...
  return <>
    ...
    <section className="shell customer-account-page">
      <div className="customer-page-heading"><div><div className="eyebrow">Νέο ραντεβού</div><h2>Διάλεξε άνθρωπο και ώρα</h2></div><p>Η ώρα δεσμεύεται άμεσα στο ΚΟΝΤΑ ΜΟΥ. Δεν δημιουργούμε αυτόματα εξωτερικό Meet/Viber/WhatsApp link· για τηλεφωνική επικοινωνία το κατάστημα θα χρησιμοποιήσει τα στοιχεία της παραγγελίας/λογαριασμού μόνο όπου επιτρέπεται.</p></div>
