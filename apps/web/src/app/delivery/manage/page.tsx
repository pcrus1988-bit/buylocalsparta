...
export default async function DeliveryManagerPage() {
  ...
  return <main className={styles.page}>
    ...
    <section className={`${styles.shell} ${styles.hero}`}>
      ...
      <p className={styles.lead}>Operational oversight of the autonomous dispatcher, fleet state, fairness, forecasts and dual-control Red Mode. Customer communication remains an Admin authority.</p>
    </section>
