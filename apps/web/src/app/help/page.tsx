...
const helpPaths = [
  ...
  ["Έχω κατάστημα στη Σπάρτη", "Δες την καταλληλότητα, τα στάδια onboarding και τι χρειάζεται πριν την ενεργοποίηση.", "/join", "Γίνε συνεργάτης"]
] as const;
