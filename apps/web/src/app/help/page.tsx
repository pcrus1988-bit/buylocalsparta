...
const helpPaths = [
  ...
  ["Έχω απορία για την πληρωμή", "Μάθε πώς υπολογίζεται το σύνολο, πότε μεταφέρεσαι στη Mollie και πώς επιβεβαιώνεται η αγορά.", "/payments-security", "Πληρωμές & ασφάλεια"],
