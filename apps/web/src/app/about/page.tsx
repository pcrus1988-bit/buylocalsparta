...
export const metadata: Metadata = {
  title: "Η ιδέα του Buy Local Sparta",
...
export default function AboutPage() {
  return <main>
    ...
    <SiteHeader />
    <section className="content-hero content-hero-about"><div className="shell content-hero-grid"><div><div className="eyebrow light">Η ιδέα πίσω από την πλατφόρμα</div><h1>Η τεχνολογία πρέπει να φέρνει την τοπική αγορά πιο κοντά.</h1><p>Το Buy Local Sparta δημιουργείται ως πιλοτικό μοντέλο για τη Σπάρτη και την ευρύτερη περιοχή: μια κοινή ψηφιακή βιτρίνα που δεν αφαιρεί το πρόσωπο, τη γνώση ή την ταυτότητα του καταστήματος.</p><div className="hero-actions"><a className="button button-light" href="/shops">Γνώρισε την αγορά</a><a className="button content-outline" href="/join">Για τοπικά καταστήματα</a></div></div><div className="about-monogram" aria-hidden="true"><span>B</span><span>L</span><span>S</span><small>SPARTA · LOCAL COMMERCE</small></div></div></section>
