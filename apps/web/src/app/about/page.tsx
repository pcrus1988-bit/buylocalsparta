...
export function generateMetadata(): Promise<Metadata> {
  return governedStaticSeoMetadata("/about", {
    ...
    description: "Το ΚΟΝΤΑ ΜΟΥ είναι πλατφόρμα τοπικού εμπορίου από τη Σπάρτη: μία διαδικασία ολοκλήρωσης αγοράς για αγορές από πολλαπλά καταστήματα και ψηφιακή υποδομή πωλήσεων, παραγγελιών, εκπλήρωσης και παράδοσης για μικρές επιχειρήσεις."
  });
}
  ...
  return <main>
    ...
    <section className="shell content-section" aria-labelledby="what-is-kontamou">
      <div className="content-heading">
        ...
        <p>Το ΚΟΝΤΑ ΜΟΥ είναι πλατφόρμα τοπικού εμπορίου από τη Σπάρτη. Επιτρέπει σε πελάτες να ανακαλύπτουν και να αγοράζουν προϊόντα από περισσότερα τοπικά καταστήματα με ένα καλάθι και μία διαδικασία ολοκλήρωσης αγοράς, ενώ δίνει στις μικρές επιχειρήσεις ψηφιακή βιτρίνα, διαχείριση παραγγελιών και εκπλήρωσης, υποστήριξη παράδοσης και πανελλαδική ψηφιακή ορατότητα χωρίς να χρειάζεται να λειτουργούν δικό τους ηλεκτρονικό κατάστημα.</p>
      </div>
      <div className="principle-grid principle-grid-three">
        <article><span>01</span><h3>Ένα καλάθι και μία ολοκλήρωση αγοράς</h3><p>Ο πελάτης μπορεί να αγοράζει προϊόντα που προέρχονται από διαφορετικά ενεργά τοπικά καταστήματα μέσα από μία ενιαία εμπειρία παραγγελίας και πληρωμής.</p></article>
        <article><span>02</span><h3>Ask Local και πραγματικοί άνθρωποι</h3><p>Η ψηφιακή αγορά συνδέεται με τη γνώση των τοπικών επαγγελματιών, ώστε ο πελάτης να μπορεί να ζητήσει συμβουλή πριν αποφασίσει τι θα αγοράσει.</p></article>
        <article><span>03</span><h3>Υποδομή για μικρές επιχειρήσεις</h3><p>Το κατάστημα αποκτά ψηφιακή παρουσία, εργαλεία παραγγελιών και εκπλήρωσης, υποστήριξη παράδοσης και πρόσβαση σε πελάτες πέρα από τη φυσική του βιτρίνα χωρίς να χρειάζεται να συντηρεί μόνο του ένα πλήρες ηλεκτρονικό κατάστημα.</p></article>
      </div>
    </section>
