...
export function generateMetadata(): Promise<Metadata> {
  return governedStaticSeoMetadata("/join/sparta", {
  title: "Συνεργασία καταστημάτων · Σπάρτη",
  description: "Προγράμματα συνεργασίας αποκλειστικά για επιχειρήσεις που αντιστοιχίζονται στο ενεργό HUB Σπάρτης."
  });
}
...
export default function JoinPage() {
  return <main>
    <div className="announcement">Σπάρτη · τα παρακάτω προγράμματα ισχύουν μόνο για επιχειρήσεις του ενεργού HUB Σπάρτης.</div>
    <SiteHeader compact />
