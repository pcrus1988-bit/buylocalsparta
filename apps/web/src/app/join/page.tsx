...
export default function JoinPage() {
  return <main>
    ...
    <section className="shell ask-local section"><div><div className="eyebrow">Pilot phase</div><h2>Founding / Early Bird</h2><p>Η εγκεκριμένη configuration του build διατηρεί το Founding / Early Bird πλαίσιο· οι τελικοί συμβατικοί, φορολογικοί και PSP όροι παραμένουν launch gates και δεν παρουσιάζονται ως ήδη ενεργοί.</p><div className="hero-actions"><a className="button" href="/about">Η αποστολή της πλατφόρμας</a><a className="button button-secondary" href="/how-it-works">Η εμπειρία πελάτη</a></div></div><div className="fairness-note"><strong>Είσαι ήδη εγκεκριμένος συνεργάτης;</strong><p>Συνδέσου στο προστατευμένο vendor workspace. Οι νέες αιτήσεις ενεργοποιούνται μόνο μέσω της ελεγχόμενης ροής onboarding και όχι μέσω ενός δημόσιου shortcut.</p><a className="text-link" href="/vendor/login">Είσοδος συνεργαζόμενου καταστήματος →</a></div></section>
    <SiteFooter />
  </main>;
}
