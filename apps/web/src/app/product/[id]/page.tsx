    ...
    <main>
      ...
      <section className="shell product-detail">
        ...
        <div className="product-detail-copy">
          ...
          <p className="lead compact">Βλέπεις την τελική τιμή ενός επιλέξιμου τοπικού καταστήματος για αυτό το προϊόν. Το Buy Local δεν προσθέτει προσαύξηση στην τιμή προϊόντος.</p>
          ...
          <div className="detail-assurances"><div><strong>Ένα προϊόν, μία επιλογή κάθε φορά</strong><span>Το ίδιο προϊόν δεν εμφανίζεται ως λίστα ανταγωνιστικών καταστημάτων. Η πλατφόρμα κατανέμει ισότιμα την έκθεση μεταξύ επιλέξιμων τοπικών vendors.</span></div><div><strong>Η τιμή είναι του καταστήματος</strong><span>Η τιμή που βλέπεις είναι η τελική τιμή που όρισε το συγκεκριμένο κατάστημα, χωρίς product markup από το Buy Local.</span></div><div><strong>Σταθερή ανάθεση</strong><span>Όσο το offer παραμένει επιλέξιμο, κρατάμε το ίδιο κατάστημα και την ίδια τιμή σε αναζήτηση, προϊόν και καλάθι.</span></div></div>
        </div>
      </section>
      <SiteFooter />
    </main>
