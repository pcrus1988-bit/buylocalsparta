...
import { reconcileVivaTransactionSafely as reconcileTransactionSafely } from "../../../lib/viva-runtime";
...
export default async function Page({ searchParams }: Props) {
  ...
  try {
    ...
    const result = await reconcileTransactionSafely({ transactionId, expectedOrderCode: orderCode, source: "redirect", now: Date.now() });
