...
export default async function PartnerNetworkAdminPage() {
  ...
  return <main className="vendor-app admin-app admin-partner-network">
    ...
    ]} /> : <section className="shell vendor-section"><div className="workspace-action-bar"><span>Live Partner Network metrics will appear after migration 0215 is applied to the connected database.</span></div></section>}
