  ...
  return <main className="vendor-app admin-app admin-catalogue-overview">
    ...
    <section className="shell vendor-section">
      ...
      <div className="catalogue-workflow-grid">
        ...
        <Link className={`catalogue-workflow-card${data.attributes.unmappedObservations > 0 ? " needs-attention" : ""}`} href="/admin/catalogue/attribute-matching"><span>Normalize · train attributes</span><strong>Attribute Matching</strong><p>Swipe through high-impact supplier attributes and teach reusable canonical or rejection rules.</p><b>{data.attributes.unmappedObservations.toLocaleString("el-GR")}</b><i>train unmapped observations →</i></Link>
      ...
      <div className="shell">
        ...
        <div className="catalogue-attention-grid">
          <article className="workspace-queue-card">
            ...
            <div className="workspace-action-bar"><span>Resolve repeated source keys once and teach future imports.</span><Link className="button button-primary" href="/admin/catalogue/attribute-matching">Train Attributes</Link></div>
          </article>
