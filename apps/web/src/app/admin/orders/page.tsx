...
export default async function Page({ searchParams }: { searchParams: Promise<{ customer?: string; order?: string; q?: string; status?: string; view?: string }> }) {
  ...
  return <main className="vendor-app admin-app">
    ...
    <section className="shell vendor-hero vendor-hero-compact dashboard-hero-refined"><div><div className="eyebrow">Operations · orders</div><h1>Παραγγελίες</h1><p className="lead">Directory-first εικόνα για τις παραγγελίες. Saved operational views μειώνουν το επαναλαμβανόμενο filtering, ενώ returns/refunds παραμένουν ξεχωριστή governed exception queue.</p></div></section>
