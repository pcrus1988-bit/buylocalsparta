...
export default async function Page({ searchParams }: { searchParams: Promise<{ q?: string; status?: string; view?: string }> }) {
  ...
  return <main className="vendor-app admin-app">
    ...
    <section className="shell vendor-section">
      <WorkspaceSectionHeading eyebrow="Directory" title="Customer accounts" note="Account state and operator attention are shown separately: a lifecycle state remains factual, while the second line identifies a concrete review condition." />
