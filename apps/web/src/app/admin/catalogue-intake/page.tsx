...
export default async function Page({ searchParams }: { searchParams: Promise<Params> }) {
  ...
  return <main className="vendor-app admin-app">
    ...
    <section className="shell vendor-section">
      ...
      <div className="workspace-action-bar" style={{marginBottom:"1rem"}}><span>After an enum attribute is mapped, repeated external values are reviewed once in a grouped exact-value queue.</span><Link className="button button-secondary" href="/admin/catalogue-intake/values">Review controlled values</Link></div>
