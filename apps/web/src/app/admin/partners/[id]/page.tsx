...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  const renewableAgreement = Boolean(
    canFinanceWrite &&
  ...
  return <main className="vendor-app admin-app">
    ...
    <section id="partner-agreement" className="shell vendor-section admin-anchor-section">
      ...
      {shop.agreement ? <div className="workspace-compact-list">
        ...
        <div className="workspace-compact-row"><strong>Term</strong><span>{new Date(shop.agreement.startsAt).toLocaleString("el-GR")} → {shop.agreement.endsAt ? new Date(shop.agreement.endsAt).toLocaleString("el-GR") : "open-ended"}</span></div>
      ...
      {renewableAgreement && shop.agreement?.endsAt && <WorkspaceRecordDetails label="Renewal / extension"><VendorAgreementRenewalForm vendorId={shop.id} agreementId={shop.agreement.id} agreementCode={shop.agreement.code} currentEndsAt={shop.agreement.endsAt} csrfToken={managed.csrfToken} /></WorkspaceRecordDetails>}
