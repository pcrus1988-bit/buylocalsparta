...
const SEMANTIC_PAGES: Readonly<Record<string, Omit<AdminAssistantPageDefinition, "route">>> = {
  ...
  "/admin/icecat": { pageType: "icecat_control", domain: "catalogue", contextLabel: "Catalogue > Icecat Control Center", entityType: "provider_operation", purpose: "Monitor Open Icecat ingestion and enrichment, diagnose provider queues and govern live worker behavior.", attention: ["worker enablement", "stalled ingestion", "systematic rejection", "enrichment backlog", "publication boundary"] },
  "/admin/catalogue-intake/import": { pageType: "catalogue_import", domain: "catalogue", contextLabel: "Catalogue > File Import", entityType: "ingestion_job", purpose: "Analyze supplier files and operate governed trusted-file adapters before Supplier PIM intake.", attention: ["schema inference", "identity evidence", "trusted payload state", "publication boundary"] },
