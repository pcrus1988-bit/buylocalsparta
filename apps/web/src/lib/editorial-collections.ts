...
export const EDITORIAL_COLLECTIONS: readonly EditorialCollection[] = [
  {
    ...
    story: "Περιποίηση προσώπου, σώματος και μαλλιών σε μία ήρεμη επιλογή από όσα είναι πραγματικά διαθέσιμα τώρα στο ΚΟΝΤΑ ΜΟΥ. Καθαρισμός, ενυδάτωση, serum και hair care — μόνο ενεργά προϊόντα που μπορούν να αγοραστούν.",
    searches: [
  ...
  },
  {
    ...
    story: "Άρωμα, χείλη, μάτια, νύχια και μικρές λεπτομέρειες για τα μαλλιά, συγκεντρωμένα από το σημερινό διαθέσιμο catalogue. Η σελίδα ανανεώνεται μαζί με τη διαθεσιμότητα, ώστε η ιδέα να οδηγεί σε προϊόντα που υπάρχουν πραγματικά.",
    searches: [
  ...
  },
  {
    ...
    story: "Μια σύντομη διαδρομή για δώρο που δεν μοιάζει πρόχειρο: αρώματα, αρωματικά κεριά και προϊόντα σώματος που είναι διαθέσιμα τώρα. Η επιλογή ανανεώνεται αυτόματα καθώς αλλάζει ο κατάλογος.",
    searches: [
