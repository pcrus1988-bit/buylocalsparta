...
const BY_LEAF: Readonly<Record<string, readonly CatalogAttributeDefinition[]>> = {
  ...
  skincare: [DEFINITIONS.gender, DEFINITIONS.skinType, DEFINITIONS.activeIngredients, DEFINITIONS.volume],
  haircare: [DEFINITIONS.gender, DEFINITIONS.hairType, DEFINITIONS.action, DEFINITIONS.volume],
  fragrance: [DEFINITIONS.gender, DEFINITIONS.concentration, DEFINITIONS.volume, DEFINITIONS.fragranceFamily],
  makeup: [DEFINITIONS.gender],
