...
export type PaintRecommendation = Readonly<{
  ...
  quantityStatus: "manufacturer-data-required" | "manufacturer-verified";
  quantityExplanation: string;
  coats: number | null;
  coverageM2PerL: number | null;
  areaM2: number;
  wastagePercent: number | null;
  litresNeeded: number | null;
...
export function recommendPaintProject(input: {
  ...
  const quantityExplanation =
    "Η ακριβής ποσότητα, ο αριθμός στρώσεων και η κάλυψη θα υπολογιστούν μόνο από τις επαληθευμένες οδηγίες του προϊόντος που θα επιλέξεις.";
  ...
  return {
    ...
    quantityStatus: "manufacturer-data-required",
    quantityExplanation,
    coats: null,
    coverageM2PerL: null,
    areaM2,
