...
const CATEGORY_CLASSIFICATION_SQL = `
...
export async function reconcileVitexStorefrontTaxonomy(): Promise<void> {
  ...
  await db.query(`
    ...
    defs(code,slug,sort_order) AS (
      VALUES
        ('paint-decorating-interior-wall','paint-decorating-interior-wall',51),
        ('paint-decorating-exterior-wall','paint-decorating-exterior-wall',52),
        ('paint-decorating-primers','paint-decorating-primers',53),
        ('paint-decorating-metal','paint-decorating-metal',54),
        ('paint-decorating-wood','paint-decorating-wood',55),
        ('paint-decorating-fillers','paint-decorating-fillers',56),
        ('paint-decorating-thinners-hardeners','paint-decorating-thinners-hardeners',57),
        ('paint-decorating-specialty','paint-decorating-specialty',58)
    )
