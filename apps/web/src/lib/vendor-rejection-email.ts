    ...
    await sendTransactionalEmailBestEffort({
      ...
      text: actionRequired
        ? [
            ...
            "",
            "Δεν βρέθηκε αυτόματα πλήρης εναλλακτική ανάθεση για όλα τα είδη. Η ομάδα KONTA MOY έχει καταγράψει το συμβάν και η παραγγελία χρειάζεται έλεγχο πριν προχωρήσει.",
        ...
        : [
            `Το κατάστημα «${row.rejected_vendor_name}» δεν μπόρεσε να εκτελέσει μέρος της παραγγελίας ${row.order_id}.`,
            "",
            "Το KONTA MOY βρήκε αυτόματα άλλο διαθέσιμο τοπικό κατάστημα και η παραγγελία συνεχίζεται χωρίς να χρειάζεται δική σου ενέργεια.",
