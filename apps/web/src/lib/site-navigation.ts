...
export const SITE_LINKS = {
  ...
  giftCards: { label: "Δωροκάρτες", href: "/gift-cards", description: "Μία δωροκάρτα για αγορές σε συμμετέχοντα καταστήματα της τοπικής αγοράς." },
...
export const INDEXABLE_STATIC_ROUTES: ReadonlyArray<IndexableStaticRoute> = [
  ...
  { ...SITE_LINKS.giftCards, changeFrequency: "monthly", priority: 0.7 },
  ...
  { ...SITE_LINKS.terms, changeFrequency: "monthly", priority: 0.5 },
