...
const STATIC_SEARCH_INTENTS: Readonly<Record<string, readonly string[]>> = {
  ...
  "/color-finder": [
    "εύρεση χρώματος τοίχου",
    "επιλογή απόχρωσης online",
    "χρωματολόγιο για σπίτι",
    "συνδυασμοί χρωμάτων Ελλάδα"
  ],
  "/paint-and-build-studio": [
    "οδηγός βαφής online",
    "προετοιμασία τοίχου για βάψιμο",
    "λύσεις βαφής και κατασκευής",
    "υλικά βαφής Ελλάδα"
  ],
  "/fitting-room": [
    "virtual fitting room Ελλάδα",
    "δοκιμή ρούχων online",
    "επιλογή μεγέθους ρούχων",
    "ρούχα online Ελλάδα"
  ],
  "/join/sparta": [
    "marketplace καταστημάτων Σπάρτη",
    "online πωλήσεις για καταστήματα Σπάρτη",
    "ψηφιακό κατάστημα Σπάρτη",
    "ένταξη επιχείρησης ΚΟΝΤΑ ΜΟΥ Σπάρτη"
  ],
  "/sitemap": [
