...
for (const contract of [
  ...
  'Το ΚΟΝΤΑ ΜΟΥ γεννήθηκε στη Σπάρτη',
  'Ένα καλάθι μπορεί να ενώνει πολλά καταστήματα.',
  'Η μικρή επιχείρηση δεν χρειάζεται να γίνει εταιρεία τεχνολογίας.',
  'Χρειάζεται πρόσβαση σε καλή τεχνολογία.',
  'Από τη Σπάρτη για την Ελλάδα'
