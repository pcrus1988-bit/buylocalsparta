...
const page = read("apps/web/src/app/advice/page.tsx"),product = read("apps/web/src/app/product/[id]/page.tsx"),vendor = read("apps/web/src/app/vendor/[id]/page.tsx");
...
if (!product.includes("/ask-local?product=") || !vendor.includes("/ask-local?vendor=")) failures.push("Product and vendor advice calls must preserve context in the live Ask Local workflow");
