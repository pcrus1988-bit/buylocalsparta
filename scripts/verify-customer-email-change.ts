...
const migration = read("db/migrations/0104_customer_verified_email_change.sql");
...
if (!postgresRuntime.includes("EXPECTED_SCHEMA_VERSION = 105")) failures.push("PostgreSQL readiness must expect schema version 105");
