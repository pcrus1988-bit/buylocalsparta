...
assert(
  ...
  "Vercel cron jobs are limited to bounded delivery dispatch, NOVA media slices and dropship order reconciliation; long-running BLS workers must remain isolated",
);
...
console.log("Deployment topology OK: locked monorepo installs, source-agnostic HTTPS catalogue images, Vercel-safe immutable production schema gate, bounded delivery, NOVA media and dropship reconciliation crons, web build and eight isolated Node 24 worker roles verified.");
