...
assert(
  ...
  "Vercel cron jobs are limited to approved bounded operational jobs; long-running BLS workers must remain isolated",
);
...
console.log("Deployment topology OK: locked monorepo installs, source-agnostic HTTPS catalogue images, Vercel-safe immutable production schema gate, approved bounded operational crons, web build and eight isolated Node 24 worker roles verified.");
