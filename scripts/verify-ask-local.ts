...
const service = read("apps/web/src/lib/ask-local-service.ts"),route = read("apps/web/src/app/api/account/ask-local/route.ts"),page = read("apps/web/src/app/ask-local/page.tsx"),client = read("apps/web/src/components/AskLocalClient.tsx"),home = read("apps/web/src/app/page.tsx"),homeSearch = read("apps/web/src/components/HomeQuickSearch.tsx"),vendorOps = read("packages/postgres-runtime/src/vendor-operations.ts");
