...
assert.ok(postgresRuntime.includes("export const EXPECTED_SCHEMA_VERSION = 219;"), "PostgreSQL runtime must require schema 219 after structured vendor pricing");
