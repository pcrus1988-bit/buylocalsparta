...
assert.ok(postgresRuntime.includes("export const EXPECTED_SCHEMA_VERSION = 216;"), "PostgreSQL runtime must require schema 216 after structured vendor pricing");
