...
VALUES
  ('agricultural_supply','auger_diameter_mm','optional','family',t,f,t,t,f,f),
  ('agricultural_supply','auger_length_cm','optional','family',t,f,t,t,f,f),
  ('agricultural_supply','telescopic_length_range','optional','family',f,f,t,f,f,f),
  ('agricultural_supply','telescopic_max_length_m','optional','family',t,f,t,t,f,f),
  ('agricultural_supply','thread_interface','optional','family',t,f,t,t,f,f),
  ('display_mount','supported_screen_size_range_in','optional','family',t,f,t,t,f,f),
  ('garden_supply','net_length_m','optional','family',t,f,t,t,f,f),
  ('hand_tool','blade_width_mm','optional','family',t,f,t,t,f,f),
  ('hand_tool','sharpening_stone_thickness_mm','optional','family',t,f,t,t,f,f),
  ('hand_tool','telescopic_length_range','optional','family',f,f,t,f,f,f),
  ('hand_tool','tool_width_mm','optional','family',t,f,t,t,f,f),
  ('hardware_item','wheel_width_mm','optional','family',t,f,t,t,f,f),
  ('homeware','hose_length_m','optional','family',t,f,t,t,f,f),
  ('homeware','pack_quantity','optional','family',t,f,t,t,f,f),
  ('homeware','weatherstrip_length_m','optional','family',t,f,t,t,f,f),
  ('irrigation_equipment','cable_length_m','optional','family',t,f,t,t,f,f),
  ('power_tool','cable_length_m','optional','family',t,f,t,t,f,f),
  ('power_tool','disc_bore_diameter_mm','optional','family',t,f,t,t,f,f),
  ('power_tool','fluid_capacity_ml','optional','family',t,f,t,t,f,f),
  ('power_tool','load_capacity_ton','optional','family',t,f,t,t,f,f),
  ('power_tool','material_thickness_mm','optional','family',t,f,t,t,f,f),
  ('power_tool','max_cutting_length_mm','optional','family',t,f,t,t,f,f),
  ('power_tool','nozzle_diameter_mm','optional','family',t,f,t,t,f,f),
  ('power_tool','suction_cup_diameter_mm','optional','family',t,f,t,t,f,f),
  ('power_tool','tool_width_mm','optional','family',t,f,t,t,f,f),
  ('tool_accessory','fluid_capacity_ml','optional','family',t,f,t,t,f,f),
  ('tool_accessory','nozzle_diameter_mm','optional','family',t,f,t,t,f,f),
  ('tool_accessory','overall_length_mm','optional','family',t,f,t,t,f,f),
  ('tool_accessory','welding_wire_classification','optional','family',t,t,t,t,f,f),
  ('vehicle_accessory','lift_height_range_mm','optional','family',f,f,t,f,f,f),
  ('vehicle_accessory','max_lift_height_mm','optional','family',t,f,t,t,f,f),
  ('vehicle_accessory','min_lift_height_mm','optional','family',t,f,t,t,f,f);
