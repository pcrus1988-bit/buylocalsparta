...
CREATE TABLE public.open_icecat_bulk_ingestion_runs (
  ...
  UNIQUE (source_id, import_kind, source_fingerprint),
...
COMMENT ON COLUMN public.open_icecat_bulk_ingestion_runs.persisted IS
  'Accepted Open Icecat index candidates written to operational index staging. This is not a canonical-product or publication count.';
