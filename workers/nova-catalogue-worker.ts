...
try {
  while (!stopping) {
    try {
      ...
      // Materialisation is deliberately isolated from ingestion. A catalogue-linking
      // problem must not stop source evidence, deleted-feed processing, or watermarks.
      try {
