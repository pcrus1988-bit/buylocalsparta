...
const ROLE_PERMISSIONS: Record<Role, ReadonlySet<Permission>> = {
  ...
  super_admin: new Set(["catalog.read", "catalog.write", "inventory.read", "inventory.write", "fulfilment.read", "fulfilment.write", "advice.read", "advice.write", "finance.read", "finance.write", "fairness.read", "fairness.manage", "content.read", "content.write", "customer.read", "customer.manage", "customer.export", "vendor.manage", "admin.audit.read", "analytics.market.read", "notifications.read", "notifications.manage", "security.read", "reviews.read", "reviews.manage", "promotions.read", "promotions.write", "privacy.read", "privacy.manage", "accessibility.read", "accessibility.manage", "returns.read", "returns.manage"]),
  vendor_operations: new Set(["catalog.read", "inventory.read", "fulfilment.read", "fulfilment.write", "fairness.read", "fairness.manage", "content.read", "vendor.manage", "admin.audit.read", "analytics.market.read", "notifications.read", "security.read", "reviews.read", "reviews.manage", "privacy.read", "accessibility.read", "accessibility.manage", "returns.read"]),
  ...
  customer_support: new Set(["catalog.read", "fulfilment.read", "advice.read", "advice.write", "customer.read", "customer.manage", "admin.audit.read", "notifications.read", "reviews.read", "reviews.manage", "privacy.read", "privacy.manage", "accessibility.read", "accessibility.manage", "returns.read", "returns.manage"]),
  ...
  compliance: new Set(["catalog.read", "catalog.write", "fairness.read", "vendor.manage", "admin.audit.read", "reviews.read", "reviews.manage", "privacy.read", "accessibility.read", "accessibility.manage", "returns.read", "returns.manage"]),
  logistics: new Set(["inventory.read", "fulfilment.read", "fulfilment.write", "returns.read"]),
  auditor: new Set(["catalog.read", "inventory.read", "fulfilment.read", "advice.read", "finance.read", "fairness.read", "content.read", "admin.audit.read", "analytics.market.read", "notifications.read", "security.read", "reviews.read", "privacy.read", "accessibility.read", "returns.read"])
};
